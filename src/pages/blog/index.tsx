            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <CardBlogMain href={"/blog/etapas-do-processo-do-design-centrado-no-usuario"} title={"Do insight à inovação: As etapas cruciais do Design Centrado no Usuário!"} text={"UCD, ou Design Centrado no Usuário (User Centered Design), é uma abordagem de design que coloca as necessidades e preferências dos usuários como o principal foco durante o processo de desenvolvimento de produtos ou serviços."} data={"17"} tempo={"05"} tam={"100%"} path={"/images/capa-design.jpg"} tamW={"5000"} tamH={"3333"} description={"João Pedro Rezende"} />
                    </Stack>
                </Stack>
                <Stack
                    px={{ base: 6, md: 8, lg: 12 }}
                ...
                >
                    ...
                    >
                        ...
                        <CardBlogMainV href={"/blog/etapas-do-processo-do-design-centrado-no-usuario"} title={"Do insight à inovação: As etapas cruciais do Design Centrado no Usuário!"} text={"UCD, ou Design Centrado no Usuário (User Centered Design), é uma abordagem de design que coloca as necessidades e preferências dos usuários como o principal foco durante o processo de desenvolvimento de produtos ou serviços."} data={"17"} tempo={"05"} tam={"100%"} path={"/images/capa-design.jpg"} tamW={"5000"} tamH={"3333"} description={"João Pedro Rezende"} />
